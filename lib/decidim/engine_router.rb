...
module Decidim
  ...
  class EngineRouter
    ...
    def method_missing(method_name, *args)
      # Allow comments on global blog posts HACKY
      if %i[ema_blog_post_path ema_blog_post_url ema_blog].include?(method_name)
        return Rails.application.routes.url_helpers.send(method_name, *args)
      end
